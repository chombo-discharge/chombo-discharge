...
def write_template(args):
    ...
    mainf.write('#include <CD_MeshODEStepper.H>\n')    
    mainf.write("\n")
    mainf.write("using namespace ChomboDischarge;\n")
    mainf.write("using namespace Physics::MeshODE;\n")
    mainf.write("\n")
    ...
    mainf.write("  auto timestepper = RefCountedPtr<TimeStepper> (new MeshODEStepper<1>());\n")
    mainf.write("  auto engine      = RefCountedPtr<Driver> (new Driver(compgeom, timestepper, amr));\n")
    mainf.write("\n")    
