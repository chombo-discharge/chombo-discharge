...
Real
CdrPlasmaAir3Bourdon::Electron::initialData(const RealVect a_pos, const Real a_time) const
{
...
Real
CdrPlasmaAir3Bourdon::MPlus::initialData(const RealVect a_pos, const Real a_time) const
{
  const Real factor = (a_pos - m_seed_pos).vectorLength();
