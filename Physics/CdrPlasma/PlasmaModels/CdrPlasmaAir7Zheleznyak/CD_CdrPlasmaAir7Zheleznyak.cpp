...
void
CdrPlasmaAir7Zheleznyak::parseChemistry()
{
...
void
CdrPlasmaAir7Zheleznyak::parseTransportFile()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::parseTransport()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::parseGasParameters()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::parseElectronMobility()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::parseElectronDiffusionCoefficient()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::parseAlpha()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::parseEta()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::parseTemperature()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::parseSEE()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::initRNG()
{
  ParmParse pp("CdrPlasmaAir7Zheleznyak");
...
void
CdrPlasmaAir7Zheleznyak::initSpecies()
{
  m_numCdrSpecies = 7;
  m_numRtSpecies  = 1;
...
void
CdrPlasmaAir7Zheleznyak::parseDomainBc()
{
...
void
CdrPlasmaAir7Zheleznyak::advanceReactionNetwork(Vector<Real>&          a_particle_sources,
...
void
CdrPlasmaAir7Zheleznyak::advanceChemistryEuler(Vector<Real>&          a_particle_sources,
                                               Vector<Real>&          a_Photon_sources,
...
int
CdrPlasmaAir7Zheleznyak::poissonReaction(const Real a_propensity, const Real a_dt) const
{
  int        value = 0;
...
Vector<Real>
CdrPlasmaAir7Zheleznyak::computeCdrDiffusionCoefficients(const Real         a_time,
                                                         const RealVect     a_pos,
                                                         const RealVect     a_E,
...
Vector<RealVect>
CdrPlasmaAir7Zheleznyak::computeCdrDriftVelocities(const Real         a_time,
                                                   const RealVect     a_pos,
                                                   const RealVect     a_E,
                                                   const Vector<Real> a_cdr_densities) const
{
...
Vector<Real>
CdrPlasmaAir7Zheleznyak::computeCdrDomainFluxes(const Real           a_time,
                                                const RealVect       a_pos,
                                                const int            a_dir,
...
Vector<Real>
CdrPlasmaAir7Zheleznyak::computeCdrElectrodeFluxes(const Real         a_time,
                                                   const RealVect     a_pos,
...
Vector<Real>
CdrPlasmaAir7Zheleznyak::computeCdrDielectricFluxes(const Real         a_time,
                                                    const RealVect     a_pos,
                                                    const RealVect     a_normal,
                                                    const RealVect     a_E,
                                                    const Vector<Real> a_cdr_densities,
...
Vector<Real>
CdrPlasmaAir7Zheleznyak::computeCdrFluxes(const Real         a_time,
                                          const RealVect     a_pos,
                                          const RealVect     a_normal,
                                          const RealVect     a_E,
                                          const Vector<Real> a_cdr_densities,
...
Real
CdrPlasmaAir7Zheleznyak::initialSigma(const Real a_time, const RealVect a_pos) const
{
  return 0.0;
}

Real
CdrPlasmaAir7Zheleznyak::computeAlpha(const Real a_E, const RealVect a_pos) const
{
  return m_e_alpha.getEntry<1>(a_E);
}

Real
CdrPlasmaAir7Zheleznyak::excitationRates(const Real a_E) const
{
...
Real
CdrPlasmaAir7Zheleznyak::sergeyFactor(const Real a_O2frac) const
{
