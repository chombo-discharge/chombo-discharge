...
void
CdrPlasmaAir3Zheleznyak::parseChemistry()
{
...
void
CdrPlasmaAir3Zheleznyak::parseTransportFile()
{
  ParmParse pp("CdrPlasmaAir3Zheleznyak");
...
void
CdrPlasmaAir3Zheleznyak::parseTransport()
{
  ParmParse pp("CdrPlasmaAir3Zheleznyak");
  ...
  m_isMobile_Electrons = (str == "true") ? true : false;
...
void
CdrPlasmaAir3Zheleznyak::parseGasParameters()
{
  ParmParse pp("CdrPlasmaAir3Zheleznyak");
...
void
CdrPlasmaAir3Zheleznyak::parseElectronMobility()
{
...
void
CdrPlasmaAir3Zheleznyak::parseElectronDiffusionCoefficient()
{
...
void
CdrPlasmaAir3Zheleznyak::parseAlpha()
{
...
void
CdrPlasmaAir3Zheleznyak::parseEta()
{
...
void
CdrPlasmaAir3Zheleznyak::parseSEE()
{
  ParmParse pp("CdrPlasmaAir3Zheleznyak");
...
void
CdrPlasmaAir3Zheleznyak::initRNG()
{
  ParmParse pp("CdrPlasmaAir3Zheleznyak");
...
void
CdrPlasmaAir3Zheleznyak::initSpecies()
{
  m_numCdrSpecies = 3;
  m_numRtSpecies  = 1;
...
void
CdrPlasmaAir3Zheleznyak::parse_initial_particles()
{
  ...
  pp.getarr("gaussian_pairs_center", vec, 0, SpaceDim);
  center_pairs = RealVect(D_DECL(vec[0], vec[1], vec[2]));
...
void
CdrPlasmaAir3Zheleznyak::addUniformParticles(List<Particle>& a_particles, const int a_num, const Real a_weight)
{
  ...
  pp.getarr("lo_corner", vec, 0, SpaceDim);
  lo = RealVect(D_DECL(vec[0], vec[1], vec[2]));
  pp.getarr("hi_corner", vec, 0, SpaceDim);
...
RealVect
CdrPlasmaAir3Zheleznyak::randomGaussian()
{
...
RealVect
CdrPlasmaAir3Zheleznyak::randomDirection()
{
#if CH_SPACEDIM == 2
...
#if CH_SPACEDIM == 2
RealVect
CdrPlasmaAir3Zheleznyak::randomDirection2D()
{
...
#if CH_SPACEDIM == 3
RealVect
CdrPlasmaAir3Zheleznyak::randomDirection3D()
{
  const Real EPS = 1.E-8;
  Real       x1  = 2.0;
  Real       x2  = 2.0;
...
void
CdrPlasmaAir3Zheleznyak::parseDomainBc()
{
...
void
CdrPlasmaAir3Zheleznyak::advanceReactionNetwork(Vector<Real>&          a_particle_sources,
...
void
CdrPlasmaAir3Zheleznyak::advanceChemistryEuler(Vector<Real>&          a_particle_sources,
                                               Vector<Real>&          a_Photon_sources,
...
int
CdrPlasmaAir3Zheleznyak::poissonReaction(const Real a_propensity, const Real a_dt) const
{
  int        value = 0;
...
Vector<Real>
CdrPlasmaAir3Zheleznyak::computeCdrDiffusionCoefficients(const Real         a_time,
                                                         const RealVect     a_pos,
                                                         const RealVect     a_E,
...
Vector<RealVect>
CdrPlasmaAir3Zheleznyak::computeCdrDriftVelocities(const Real         a_time,
                                                   const RealVect     a_pos,
                                                   const RealVect     a_E,
                                                   const Vector<Real> a_cdr_densities) const
{
...
Vector<Real>
CdrPlasmaAir3Zheleznyak::computeCdrDomainFluxes(const Real           a_time,
                                                const RealVect       a_pos,
                                                const int            a_dir,
...
Vector<Real>
CdrPlasmaAir3Zheleznyak::computeCdrElectrodeFluxes(const Real         a_time,
                                                   const RealVect     a_pos,
                                                   ...
                                                   const Vector<Real> a_extrap_cdr_fluxes) const
{
  return computeCdrFluxes(a_time,
                          a_pos,
                          a_normal,
                          a_E,
                          a_cdr_densities,
...
Vector<Real>
CdrPlasmaAir3Zheleznyak::computeCdrDielectricFluxes(const Real         a_time,
                                                    const RealVect     a_pos,
                                                    const RealVect     a_normal,
                                                    const RealVect     a_E,
                                                    const Vector<Real> a_cdr_densities,
...
Vector<Real>
CdrPlasmaAir3Zheleznyak::computeCdrFluxes(const Real         a_time,
                                          const RealVect     a_pos,
                                          const RealVect     a_normal,
                                          const RealVect     a_E,
                                          const Vector<Real> a_cdr_densities,
...
Real
CdrPlasmaAir3Zheleznyak::initialSigma(const Real a_time, const RealVect a_pos) const
{
  return 0.0;
}

Real
CdrPlasmaAir3Zheleznyak::computeAlpha(const Real a_E, const RealVect a_pos) const
{
...
Real
CdrPlasmaAir3Zheleznyak::excitationRates(const Real a_E) const
{
...
Real
CdrPlasmaAir3Zheleznyak::sergeyFactor(const Real a_O2frac) const
{
