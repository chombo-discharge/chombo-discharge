...
Real
CdrPlasmaAir3Zheleznyak::Electron::initialData(const RealVect a_pos, const Real a_time) const
{
...
Real
CdrPlasmaAir3Zheleznyak::MPlus::initialData(const RealVect a_pos, const Real a_time) const
{
  const Real factor = (a_pos - m_seed_pos).vectorLength();
...
Real
CdrPlasmaAir3Zheleznyak::uv_Photon::getAbsorptionCoefficient(const RealVect a_pos) const
{
  return getRandomKappa();
}

Real
CdrPlasmaAir3Zheleznyak::uv_Photon::getRandomKappa() const
{
