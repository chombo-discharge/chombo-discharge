...
void
CdrPlasmaAir7Stephens::parseChemistry()
{
...
void
CdrPlasmaAir7Stephens::parseTransportFile()
{
  ParmParse pp("CdrPlasmaAir7Stephens");
...
void
CdrPlasmaAir7Stephens::parseTransport()
{
  ParmParse pp("CdrPlasmaAir7Stephens");
...
void
CdrPlasmaAir7Stephens::parseGasParameters()
{
  ParmParse pp("CdrPlasmaAir7Stephens");
...
void
CdrPlasmaAir7Stephens::parseElectronMobility()
{
...
void
CdrPlasmaAir7Stephens::parseElectronDiffusionCoefficient()
{
...
void
CdrPlasmaAir7Stephens::parseAlpha()
{
  ParmParse pp("CdrPlasmaAir7Stephens");
...
void
CdrPlasmaAir7Stephens::parseEta()
{
...
void
CdrPlasmaAir7Stephens::parseTemperature()
{
...
void
CdrPlasmaAir7Stephens::parseExcitations()
{
...
void
CdrPlasmaAir7Stephens::parseSEE()
{
  ParmParse pp("CdrPlasmaAir7Stephens");
...
void
CdrPlasmaAir7Stephens::parsePhotoi()
{
  ParmParse pp("CdrPlasmaAir7Stephens");
...
void
CdrPlasmaAir7Stephens::initSpecies()
{
  m_numCdrSpecies = 7;
  m_numRtSpecies  = 8;
...
void
CdrPlasmaAir7Stephens::parseDomainBc()
{
...
void
CdrPlasmaAir7Stephens::advanceReactionNetwork(Vector<Real>&          a_particle_sources,
...
void
CdrPlasmaAir7Stephens::advanceChemistryEuler(Vector<Real>&          a_particle_sources,
                                             Vector<Real>&          a_Photon_sources,
...
int
CdrPlasmaAir7Stephens::poisson_reaction(const Real a_propensity, const Real a_dt) const
{
  int        value = 0;
...
int
CdrPlasmaAir7Stephens::binomial_trials(const int a_trials, const Real a_p) const
{
...
Vector<Real>
CdrPlasmaAir7Stephens::computeCdrDiffusionCoefficients(const Real         a_time,
                                                       const RealVect     a_pos,
                                                       const RealVect     a_E,
...
Vector<RealVect>
CdrPlasmaAir7Stephens::computeCdrDriftVelocities(const Real         a_time,
                                                 const RealVect     a_pos,
                                                 const RealVect     a_E,
                                                 const Vector<Real> a_cdr_densities) const
{
...
Vector<Real>
CdrPlasmaAir7Stephens::computeCdrDomainFluxes(const Real           a_time,
                                              const RealVect       a_pos,
                                              const int            a_dir,
...
Vector<Real>
CdrPlasmaAir7Stephens::computeCdrElectrodeFluxes(const Real         a_time,
                                                 const RealVect     a_pos,
...
Vector<Real>
CdrPlasmaAir7Stephens::computeCdrDielectricFluxes(const Real         a_time,
                                                  const RealVect     a_pos,
                                                  const RealVect     a_normal,
                                                  const RealVect     a_E,
                                                  const Vector<Real> a_cdr_densities,
...
Vector<Real>
CdrPlasmaAir7Stephens::computeCdrFluxes(const Real         a_time,
                                        const RealVect     a_pos,
                                        const RealVect     a_normal,
                                        const RealVect     a_E,
                                        const Vector<Real> a_cdr_densities,
...
Real
CdrPlasmaAir7Stephens::initialSigma(const Real a_time, const RealVect a_pos) const
{
  return 0.0;
}

Real
CdrPlasmaAir7Stephens::computeAlpha(const Real a_E, const RealVect a_pos) const
{
