...
void CdrPlasmaAir9EedBourdon::parseTransportFile(){
...
void CdrPlasmaAir9EedBourdon::parseGas_parameters(Real& a_Tg, Real& a_p, Real& a_N, Real& a_O2frac, Real& a_N2frac){
  ParmParse pp("CdrPlasmaAir9EedBourdon");
...
void CdrPlasmaAir9EedBourdon::parsePhotoi(){
  ParmParse pp("CdrPlasmaAir9EedBourdon");
...
void CdrPlasmaAir9EedBourdon::parseSEE(){
  ParmParse pp("CdrPlasmaAir9EedBourdon");
...
void CdrPlasmaAir9EedBourdon::parseTransport(){
  ParmParse pp("CdrPlasmaAir9EedBourdon");
...
Real CdrPlasmaAir9EedBourdon::compute_Electron_energy(const Real a_energy_density, const Real a_Electron_density) const{
  const Real factor = 1.E8;
  return a_energy_density/(factor+a_Electron_density);
}

Vector<Real> CdrPlasmaAir9EedBourdon::computeCdrDiffusionCoefficients(const Real         a_time,
...
Vector<RealVect> CdrPlasmaAir9EedBourdon::computeCdrDriftVelocities(const Real         a_time,
								    const RealVect     a_pos,
								    const RealVect     a_E,
								    const Vector<Real> a_cdr_densities) const {
...
void CdrPlasmaAir9EedBourdon::advanceReactionNetwork(Vector<Real>&          a_cdr_sources,
...
Vector<Real> CdrPlasmaAir9EedBourdon::computeCdrDomainFluxes(const Real           a_time,
							     const RealVect       a_pos,
							     const int            a_dir,
...
Vector<Real> CdrPlasmaAir9EedBourdon::computeCdrDielectricFluxes(const Real         a_time,
								 const RealVect     a_pos,
...
Real CdrPlasmaAir9EedBourdon::initialSigma(const Real a_time, const RealVect a_pos) const {return 0.0;}

Real CdrPlasmaAir9EedBourdon::Electron_energy(const Real a_energy, const Real a_density){
...
Real CdrPlasmaAir9EedBourdon::compute_O4plus_mobility(const Real a_EbyN)   const {return m_ion_mobility;}
Real CdrPlasmaAir9EedBourdon::compute_O2plusN2_mobility(const Real a_EbyN) const {return m_ion_mobility;}
Real CdrPlasmaAir9EedBourdon::compute_O2minus_mobility(const Real a_EbyN)  const {return m_ion_mobility;}
Real CdrPlasmaAir9EedBourdon::compute_Ominus_mobility(const Real a_EbyN)   const {return m_ion_mobility;}

Real CdrPlasmaAir9EedBourdon::compute_eed_diffco(const Real a_energy) const {return (5.0/3.0)*this->compute_e_diffco(a_energy);}
Real CdrPlasmaAir9EedBourdon::compute_e_diffco(const Real a_energy)   const {return (2.0/3.0)*a_energy*this->compute_e_mobility(a_energy);}
Real CdrPlasmaAir9EedBourdon::compute_N2plus_diffco()                 const {return m_ion_diffusion;}
Real CdrPlasmaAir9EedBourdon::compute_N4plus_diffco()                 const {return m_ion_diffusion;}
Real CdrPlasmaAir9EedBourdon::compute_O2plus_diffco()                 const {return m_ion_diffusion;}
Real CdrPlasmaAir9EedBourdon::compute_O4plus_diffco()                 const {return m_ion_diffusion;}
Real CdrPlasmaAir9EedBourdon::compute_O2plusN2_diffco()               const {return m_ion_diffusion;}
...
Real CdrPlasmaAir9EedBourdon::compute_O2plus_2N2_to_O2plusN2_N2(const Real a_Tg) const {return 8.1E-38/(a_Tg*a_Tg);}
Real CdrPlasmaAir9EedBourdon::compute_O2plusN2_N2_to_O2plus_2N2(const Real a_Tg) const {return 14.8*pow(a_Tg, -5.3)*exp(-2357.0/a_Tg);}
Real CdrPlasmaAir9EedBourdon::compute_O2plusN2_O2_to_O4plus_N2()                 const {return 1.E-15;}
Real CdrPlasmaAir9EedBourdon::compute_O2plus_O2_M_to_O4plus_M(const Real a_Tg)   const {return 2.03E-34*pow(a_Tg, -3.2);}
Real CdrPlasmaAir9EedBourdon::compute_e_O4plus_to_2O2(const Real a_Te)           const {return 2.42E-11/(sqrt(a_Te));}
Real CdrPlasmaAir9EedBourdon::compute_e_O2plus_to_O2(const Real a_Te)            const {return 6.E-11/a_Te;}
Real CdrPlasmaAir9EedBourdon::compute_e_2O2_to_O2minus_O2(const Real a_Te)       const {return 6.E-39/a_Te;}
Real CdrPlasmaAir9EedBourdon::compute_O2minus_O4plus_to_3O2()                    const {return 1.E-13;}
Real CdrPlasmaAir9EedBourdon::compute_O2minus_O4plus_M_to_3O2_M(const Real a_Tg) const {return 3.12E-31*pow(a_Tg, -2.5);}
Real CdrPlasmaAir9EedBourdon::compute_O2minus_O2plus_M_to_2O2_M(const Real a_Tg) const {return 3.12E-31*pow(a_Tg, -2.5);}
Real CdrPlasmaAir9EedBourdon::compute_e_O2_to_e_2O_c1(const Real a_energy)       const {
  Real k = 0.0;
  return 0.0;
...
Real CdrPlasmaAir9EedBourdon::compute_e_O2_to_e_2O_c2(const Real a_energy)       const {
  Real k = 0.0; return k;
...
Real CdrPlasmaAir9EedBourdon::compute_e_O2_to_Ominus_O(const Real a_energy)      const {
  Real k = 0.0;return k;
...
Real CdrPlasmaAir9EedBourdon::compute_Oplus_O2_to_O_O2(const Real a_Tg)          const {return 3.46E-12/sqrt(a_Tg);}
Real CdrPlasmaAir9EedBourdon::compute_e_N2_to_e_N2(const Real a_energy)          const {
...
Real CdrPlasmaAir9EedBourdon::compute_e_O2_to_e_O2(const Real a_energy)          const {
  Real k = 0.0;return k;
  ...
  // Electron losses
Real CdrPlasmaAir9EedBourdon::compute_e_N2_ionization_loss()              const {return 15.6;}
Real CdrPlasmaAir9EedBourdon::compute_e_O2_ionization_loss()              const {return 12.07;}
Real CdrPlasmaAir9EedBourdon::compute_e_O2_dissociation_loss_c1()         const {return 5.58;}
Real CdrPlasmaAir9EedBourdon::compute_e_O2_dissociation_loss_c2()         const {return 8.4;}
Real CdrPlasmaAir9EedBourdon::compute_e_O2_dissociative_attachment_loss() const {return 3.6;}
Real CdrPlasmaAir9EedBourdon::compute_e_O2_scattering_loss()              const {return 1;}
Real CdrPlasmaAir9EedBourdon::compute_e_N2_scattering_loss()              const {return 1;}
...
Vector<Real> CdrPlasmaAir9EedBourdon::computeCdrElectrodeFluxes(const Real         a_time,
								const RealVect     a_pos,
								const RealVect     a_normal,
								const RealVect     a_E,
								const Vector<Real> a_cdr_densities,
  ...
  if(cathode){
    ret = this->computeCathodeFluxes(a_time, a_pos, a_normal, a_E, a_cdr_densities, a_cdr_velocities, a_cdr_gradients,
				     a_rte_fluxes, a_extrap_cdr_fluxes, m_townsend2_electrode, m_electrode_quantum_efficiency);
  }
  else if(anode){
    ret = this->computeAnodeFluxes(a_time, a_pos, a_normal, a_E, a_cdr_densities, a_cdr_velocities, a_cdr_gradients,
				   a_rte_fluxes, a_extrap_cdr_fluxes, m_townsend2_electrode, m_electrode_quantum_efficiency);
  }
...
Vector<Real> CdrPlasmaAir9EedBourdon::computeAnodeFluxes(const Real         a_time,
							 const RealVect     a_pos,
							 const RealVect     a_normal,
							 const RealVect     a_E,
							 const Vector<Real> a_cdr_densities,
...
Vector<Real> CdrPlasmaAir9EedBourdon::computeCathodeFluxes(const Real         a_time,
							   const RealVect     a_pos,
							   const RealVect     a_normal,
							   const RealVect     a_E,
							   const Vector<Real> a_cdr_densities,
