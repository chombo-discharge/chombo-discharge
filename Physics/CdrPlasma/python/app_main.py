...
def write_template(args):
    ...
    mainf.write("  auto physics     = RefCountedPtr<CdrPlasmaPhysics> (new " + args.physics + "());\n")
    mainf.write("  auto timestepper = RefCountedPtr<CdrPlasmaStepper> (new " + args.time_stepper + "(physics));\n")
    if args.cell_tagger != "none":
        mainf.write("  auto tagger      = RefCountedPtr<CellTagger> (new " + args.cell_tagger + "(physics, timestepper, amr, compgeom));\n")
    else:
    ...
    mainf.write("\n")
    mainf.write("  auto poissonFactory = new FieldSolverFactory<" + args.field_solver + ">();\n")
    mainf.write("  auto cdrFactory     = new CdrFactory<CdrSolver, " + args.cdr_solver + ">();\n")
    mainf.write("  auto rteFactory     = new RtFactory<RtSolver, " + args.rte_solver + ">();\n")
    mainf.write("\n")    
    mainf.write("  auto poi = poissonFactory->newSolver();\n");
    mainf.write("  auto cdr = cdrFactory->newLayout(physics->getCdrSpecies());\n")
    mainf.write("  auto rte = rteFactory->newLayout(physics->getRtSpecies());\n")
    mainf.write("\n")
    ...
    mainf.write("\n")
    mainf.write("  delete poissonFactory;\n")
    mainf.write("  delete cdrFactory;\n")
    mainf.write("  delete rteFactory;\n")
    mainf.write("\n")
