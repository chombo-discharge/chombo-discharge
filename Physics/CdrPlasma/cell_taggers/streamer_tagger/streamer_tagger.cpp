...
streamer_tagger::streamer_tagger(const RefCountedPtr<CdrPlasmaPhysics>&     a_physics,
				 const RefCountedPtr<cdr_plasma_stepper>&     a_timeStepper,
				 const RefCountedPtr<AmrMesh>&               a_amr,
				 const RefCountedPtr<ComputationalGeometry>& a_computationalGeometry) : streamer_tagger() {
