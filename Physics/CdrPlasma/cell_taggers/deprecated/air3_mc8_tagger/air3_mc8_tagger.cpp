/*!
  @file   air3_mc8_tagger.cpp
  @brief  Implementation air3_mc8_tagger.H
...
air3_mc8_tagger::air3_mc8_tagger(){
  m_name = "air3_mc8_tagger";
  m_num_tracers = 2;
}
...
Vector<Real> air3_mc8_tagger::tracer(const RealVect         a_pos,
				     const Real             a_time,
				     const Real             a_dx,
				     const RealVect         a_E,
				     const Real             a_min_E,
