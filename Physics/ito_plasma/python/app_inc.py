...
def copy_dependencies(args):
    ...
    kin_home = args.discharge_home + "/Physics/ito_plasma/plasma_models" + "/" + args.physics
    kin_name = args.discharge_home + "/Physics/ito_plasma/plasma_models" + "/" + args.physics + "/" + args.physics
