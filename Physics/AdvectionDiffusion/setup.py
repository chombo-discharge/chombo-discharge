...
parser.add_argument('-cdrsolver',       type=str,  help="CDR solver (default: %(default)s)", default="CdrCTU")
parser.add_argument('-geometry',        type=str,  help="Geometry class (default: %(default)s)", default="RegularGeometry")
parser.add_argument('-stepper',         type=str,  help="Time stepper class (default: %(default)s)", default="AdvectionDiffusionStepper")
