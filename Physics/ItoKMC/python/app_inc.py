...
def copy_dependencies(args):
    ...
    kin_home = args.discharge_home + "/Physics/ItoPlasma/PlasmaModels" + "/" + args.physics
    kin_name = args.discharge_home + "/Physics/ItoPlasma/PlasmaModels" + "/" + args.physics + "/" + args.physics
