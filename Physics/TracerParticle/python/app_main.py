...
def write_template(args):
    ...
    mainf.write('#include <CD_TracerParticle.H>\n')
    ...
    mainf.write("  RefCountedPtr<TimeStepper> timestepper = RefCountedPtr<TimeStepper> (new TracerParticleStepper<TracerParticle<0, 4> >());\n")
    mainf.write("\n")
