...
%    \draw[draw=black, thick, xslant=1.5, fill=red!50!white, fill opacity=0.5] (0.5,0.25) rectangle(2.5,1.75);
    \draw[densely dotted, fill=white, thin, xslant=1.5] grid[xstep=0.25, ystep=0.125] (3,2);
    \draw[solid, draw=black, thin, xslant=1.5] (0.5,0.25) rectangle(2.5,1.75);
    \draw[solid, black, thin, xslant=1.5] (0.5, 0.25) grid[xstep=0.25, ystep=0.125] (2.5,1.75);    
%    \draw[fill=black, thin, xslant=1.5] grid[xstep=0.25, ystep=0.125] (3,2);    
  \end{scope}

  \begin{scope}[xshift=3.5cm, yshift=3cm]
    \draw[densely dotted, fill=white, thin, xslant=1.5] grid[xstep=0.25, ystep=0.125] (3,2);    
    \draw[draw=black, thick, xslant=1.5, fill=orange!50!white, fill opacity=0.5] (0,0) rectangle(3,2);
    \draw[draw=black, thick, xslant=1.5, fill=red!50!white, fill opacity=0.5] (0.5,0.25) rectangle(2.5,1.75);
    \draw[fill=black, thin, xslant=1.5] (0.5, 0.25) grid[xstep=0.25, ystep=0.125] (2.5,1.75);
