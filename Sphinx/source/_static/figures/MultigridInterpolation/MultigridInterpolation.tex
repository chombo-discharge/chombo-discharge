...
\usepackage{bm}
\usetikzlibrary{arrows,shadings,shapes.arrows,decorations.pathreplacing,calc, positioning, shapes}
...
\begin{tikzpicture}[on grid]
  ...
  % Ghost region
%  \draw[step=10mm, densely dashed, black, thin] (4,4) grid  (8,5); %defining grids  
  ...
  \draw[thick, densely dashed] (5,5) -- ++ (4,0);
  \draw[thick, densely dashed] (6.5,5) -- ++ (0,-2.5);
  %% \draw (6.5,5.5) -- (9,5);
  %% \draw (6.5,5.5) -- (9,7);
  %% \draw (6.5,5.5) -- (7,7);
  %% \draw (6.5,5.5) -- (5,7);
  ...
  \node[draw=black, fill=black, diamond,inner sep=2pt] at (6.5,5) {};
