...
/*!
  @file   CD_HKRodPlaneProfile.cpp
  @brief  Implementation of CD_HKRodPlaneProfile.H
  @author Hans Kristian Meyer
*/
...
// Our includes
#include <CD_HKRodPlaneProfile.H>
...
HKRodPlaneProfile::HKRodPlaneProfile()
{
  if (SpaceDim == 3)
    MayDay::Abort("HKRodPlaneProfile::HKRodPlaneProfile - this is currently for 2D only");
  std::string  str;
  ...
  ParmParse pp("HKRodPlaneProfile");
  ...
  if (str == "circle") {
    ...
    m_profile = profile::shroom;
  }
  else {
    MayDay::Abort("HKRodPlaneProfile::HKRodPlaneProfile - unknown profile requested");
  }
...
HKRodPlaneProfile::getBaseIF()
{
  ...
  case profile::shroom:
    ...
    break;
  default:
    MayDay::Abort("HKRodPlaneProfile::getBaseIF - logic bust, unknown profile requested");
    break;
  }
...
BaseIF*
HKRodPlaneProfile::getBaseIFCircle()
{
  ParmParse pp("HKRodPlaneProfile");
...
BaseIF*
HKRodPlaneProfile::getBaseIFSquare()
{
  ParmParse pp("HKRodPlaneProfile");
