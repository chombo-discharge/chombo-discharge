...
\begin{filecontents*}{convergence_cylinder.dat}
# cells	Linf error	L1 error	L2 error
16	0.00309375	0.000680202	0.000951967
32	0.00169931	0.000338134	0.000470788
64	0.000501446	6.40076e-05	9.23736e-05
128	0.000125586	1.94673e-05	2.75388e-05
\end{filecontents*}

\begin{filecontents*}{convergence.dat}
# cells	Linf error	L1 error	L2 error
16	0.00284013	0.000489982	0.000680256
32	0.00107695	0.000107365	0.000181665
64	0.0010739	4.39354e-05	8.43356e-05
128	0.000385601	9.3763e-06	2.12879e-05
\end{filecontents*}
...
\begin{tikzpicture}
  ...
  \begin{axis}[
    ...
    \addplot[o1][domain=16:128] {4/(16*x)};
    \addplot[o2][domain=16:128] {4/(x*x)};
    \addplot[o2][domain=16:128] {0.1/(x*x)};    
