...
\begin{tikzpicture}[on grid]
  ...
  % Ghost region
  \draw[step=10mm, densely dashed, black, thin] (4,4) grid  (8,6); %defining grids  
  ...
  %% \draw (6.5,5.5) -- (5,7);
  %% \draw (6.5,5.5) -- (5,5);
  %% \draw (6.5,5.5) -- (4.5,3.5);
  %% \draw (6.5,5.5) -- (5.5,3.5);
  %% \draw (6.5,5.5) -- (6.5,3.5);
  %% \draw (6.5,5.5) -- (7.5,3.5);
  
  %% \draw[black,fill=black] (6.5,5.5) circle (3pt);
  %% \draw[black,fill=white] (4.5,3.5) circle (3pt);
  %% \draw[black,fill=white] (5.5,3.5) circle (3pt);
  %% \draw[black,fill=white] (6.5,3.5) circle (3pt);
  %% \draw[black,fill=white] (7.5,3.5) circle (3pt);
  %% \draw[black,fill=white] (5,5) circle (3pt);
  %% \draw[black,fill=white] (5,7) circle (3pt);
  %% \draw[black,fill=white] (7,5) circle (3pt);
  %% \draw[black,fill=white] (7,7) circle (3pt);
  %% \draw[black,fill=white] (9,5) circle (3pt);
  %% \draw[black,fill=white] (9,7) circle (3pt);
  ...
  \draw[black, ultra thick, draw=black, fill=black, fill opacity=1.0] (53.5,0.0) ellipse (50cm and 9.5cm);
