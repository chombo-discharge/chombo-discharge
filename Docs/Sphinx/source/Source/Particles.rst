...
.. literalinclude:: ../../../../Source/AmrMesh/CD_AmrMesh.H
   :lines: 941,942,954-970,993,994,1006-1022
   :language: c++
   :dedent: 2

Here, the template parameter ``P`` is the particle type and the template parameter ``particleScalarField`` is a C++ pointer-to-member-function that returns a ``Real``.
...
``chombo-discharge`` currently supports two methods for handling coarse-fine deposition.
...
.. literalinclude:: ../../../../Source/AmrMesh/CD_AmrMesh.H
   :lines: 1081,1082,1092-1106,1108,1109,1119-1131
   :language: c++
   :dedent: 2
