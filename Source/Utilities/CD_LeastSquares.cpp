                               ...
                               const bool         a_addStartingVof)
{
  ...
  if (normal != RealVect::Zero) { // Can only do this if we actual have a normal vector.
    ...
    case Neighborhood::SemiCircle: {
      constexpr Real deltaThresh = 0.1;
                                         ...
                                         const int               a_order)
{
  ...
  if (a_derivs.numPts() > 0) {
    ...
    //                A                   x               b
    //               ===                 ===             ===
    //     [1 (x-x0) 0.5(x-x0)^2 ...] [f(x)     ]      [f(x0)]
    //     [1 (x-x1) 0.5(x-x1)^2 ...] [df/dx    ]      [f(x1)]
    //     [1 (x-x2) 0.5(x-x2)^2 ...] [d^2f/dx^2](x) = [f(x2)]
    //     [:   :         :         ] [    :    ]      [  :  ]
    //     [:   :         :         ] [    :    ]      [  :  ]
    //
    ...
    if (foundSVD) {
      ...
      //
      //     [(x-x0) 0.5(x-x0)^2 ...] [df/dx    ]      [f(x0) - f(x)]
      //     [(x-x1) 0.5(x-x1)^2 ...] [d^2f/dx^2]      [f(x1) - f(x)]
      //     [(x-x2) 0.5(x-x2)^2 ...] [         ](x) = [f(x2) - f(x)]
      //     [  :         :         ] [    :    ]      [  :         ]
      //     [  :         :         ] [    :    ]      [  :         ]
      //
