...
void FieldSolverMultigrid::computeElectricField(MFAMRCellData& a_electricField, const MFAMRCellData& a_potential) const {
...
void FieldSolverMultigrid::computeElectricField(EBAMRCellData& a_electricField, const phase::which_phase a_phase, const MFAMRCellData& a_potential) const {
...
void FieldSolverMultigrid::computeElectricField(EBAMRFluxData& a_electricField, const phase::which_phase a_phase, const MFAMRCellData& a_potential) const {
