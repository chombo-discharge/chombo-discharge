...
RefCountedPtr<MFHelmholtzJumpBC> MFHelmholtzSaturationChargeJumpBCFactory::create(const Location::Cell a_dataLocation,
  ...
  return RefCountedPtr<MFHelmholtzJumpBC> (new MFHelmholtzSaturationChargeJumpBC(m_phase, a_dataLocation, a_mflg, a_Bcoef, a_dx, a_order, a_weight, a_radius, a_ghostCF));
}
