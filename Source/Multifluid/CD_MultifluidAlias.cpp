...
bool
MultifluidAlias::MfCellAliasFactory::callDelete() const
{
  return false;
}
...
bool
MultifluidAlias::MfFluxAliasFactory::callDelete() const
{
  return false;
}
...
bool
MultifluidAlias::MfIVAliasFactory::callDelete() const
{
  return false;
}
