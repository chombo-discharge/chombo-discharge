...
void
EBHelmholtzNeumannDomainBCFactory::setDphiDn(const Real a_DphiDn)
{
...
void
EBHelmholtzNeumannDomainBCFactory::setDphiDn(const std::function<Real(const RealVect& a_pos)>& a_DphiDn)
{
...
void
EBHelmholtzNeumannDomainBCFactory::setBxDphiDn(const Real a_BxDphiDn)
{
...
void
EBHelmholtzNeumannDomainBCFactory::setBxDphiDn(const std::function<Real(const RealVect& a_pos)>& a_BxDphiDn)
{
...
EBHelmholtzNeumannDomainBCFactory::create() const
{
