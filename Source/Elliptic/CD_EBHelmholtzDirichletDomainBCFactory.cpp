...
{
  CH_TIME(
    "EBHelmholtzDirichletDomainBCFactory::EBHelmholtzDirichletDomainBCFactory(std::function<Real(const RealVect)>)");
...
void
EBHelmholtzDirichletDomainBCFactory::setValue(const Real a_value)
{
...
void
EBHelmholtzDirichletDomainBCFactory::setValue(const std::function<Real(const RealVect& a_pos)>& a_value)
{
...
EBHelmholtzDirichletDomainBCFactory::create() const
{
