...
MFHelmholtzJumpBCFactory::MFHelmholtzJumpBCFactory() { CH_TIME("MFHelmholtzJumpBCFactory::MFHelmholtzJumpBCFactory"); }
                                 ...
                                 const int            a_ghostCF)
{
  return RefCountedPtr<MFHelmholtzJumpBC>(
    new MFHelmholtzJumpBC(a_dataLocation, a_mflg, a_Bcoef, a_dx, a_order, a_weight, a_radius, a_ghostCF));
}
