...
void
MFHelmholtzNeumannDomainBCFactory::setDphiDn(const Real a_DphiDn)
{
...
void
MFHelmholtzNeumannDomainBCFactory::setDphiDn(const std::function<Real(const RealVect& a_pos)>& a_DphiDn)
{
...
void
MFHelmholtzNeumannDomainBCFactory::setBxDphiDn(const Real a_BxDphiDn)
{
...
void
MFHelmholtzNeumannDomainBCFactory::setBxDphiDn(const std::function<Real(const RealVect& a_pos)>& a_BxDphiDn)
{
