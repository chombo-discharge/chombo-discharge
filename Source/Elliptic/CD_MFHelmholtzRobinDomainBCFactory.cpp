...
void
MFHelmholtzRobinDomainBCFactory::setCoefficients(const Real a_A, const Real a_B, const Real a_C)
{
...
void
MFHelmholtzRobinDomainBCFactory::setCoefficients(const std::function<Real(const RealVect& a_pos)>& a_A,
                                                 const std::function<Real(const RealVect& a_pos)>& a_B,
                                                 const std::function<Real(const RealVect& a_pos)>& a_C)
{
