...
void
EbFastCoarToFineRedist::fastDefine(const EBLevelGrid& a_eblgFine,
  ...
  if (debug) {
    ...
    if (procID() == uniqueProc(SerialTask::compute)) {
      if (diffSet1.numPts() != 0)
        MayDay::Error("EbFastCoarToFineRedist::define - diffSet1 not empty");
      if (diffSet2.numPts() != 0)
        MayDay::Error("EbFastCoarToFineRedist::define - diffSet2 not empty");
      if (diffSet3.numPts() != 0)
        MayDay::Error("EbFastCoarToFineRedist::define - diffSet3 not empty");
      if (diffSet4.numPts() != 0)
        MayDay::Error("EbFastCoarToFineRedist::define - diffSet4 not empty");
    }
  }
}

void
EbFastCoarToFineRedist::makeCedFineSets()
{
...
void
EbFastCoarToFineRedist::makeCoarSets()
{
...
void
EbFastCoarToFineRedist::gatherBroadcast(IntVectSet& a_set)
{
...
void
EbFastCoarToFineRedist::gatherSetsCedFine(IntVectSet& a_setsCedFine)
{
...
void
EbFastCoarToFineRedist::gatherSetsCoar(IntVectSet& a_setsCoar)
{
