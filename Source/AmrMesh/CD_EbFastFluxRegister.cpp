...
EbFastFluxRegister::EbFastFluxRegister() { CH_TIME("EbFastFluxRegister::EbFastFluxRegister"); }
...
void
EbFastFluxRegister::define(const DisjointBoxLayout& a_gridsFine,
...
void
EbFastFluxRegister::define(const EBLevelGrid& a_eblgFine,
                           const EBLevelGrid& a_eblgCoar,
                           const int&         a_refRat,
                           const int&         a_nvar,
                           const bool         a_forceNoEBCF)
{
  ...
  m_levelFluxReg->define(a_eblgFine.getDBL(), a_eblgCoar.getDBL(), a_eblgFine.getDomain(), a_refRat, a_nvar);
...
void
EbFastFluxRegister::fastDefineSetsAndIterators()
{
...
void
EbFastFluxRegister::defineMasks()
{
