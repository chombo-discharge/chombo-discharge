...
void CentroidInterpolationStencil::buildStencil(VoFStencil&              a_sten,
  ...
  case IrregStencil::StencilType::TaylorExtrapolation: {
    found_stencil = this->getTaylorExtrapolationStencil(a_sten, a_vof, a_dbl, a_domain, a_ebisbox, a_box, a_dx, noCFIVS);
    break;
  }
  ...
  for (int i = 0; i < a_sten.size(); i++){
    ...
    if(w < 0.0) MayDay::Warning("CentroidInterpolationStencil::buildStencils - I got negative weights!!!");
  }
#endif
}
...
bool CentroidInterpolationStencil::getTaylorExtrapolationStencil(VoFStencil&              a_sten,
  ...
  if(m_order == 1){
    ...
    MayDay::Abort("CentroidInterpolationStencil::getTaylorExtrapolationStencil - bad order requested. Only first and second order is supported");
  }
...
bool CentroidInterpolationStencil::getLeastSquaresStencil(VoFStencil&              a_sten,
  ...
  a_sten = LeastSquares::getInterpolationStencilUsingAllConnectedVofsInRadius(LeastSquares::CellPosition::Centroid,
