...
if $PROFILE
then
    for PATTERN in 'ItoSolver::computeLoads' \
		       'ItoSolver::writeCheckPointLevelParticles' \
		       'ItoSolver::writeCheckPointLevelFluid' \
		       'ItoSolver::readCheckpointLevelParticles' \
		       'ItoSolver::drawNewParticles' \
		       'ItoSolver::depositHybrid' \
		       ...
		       'ItoSolver::computeDt(int)' \
		       'ItoSolver::computeHopDt(Real, int)' \
