...
for i in `find . -type f \( -iname \*.H -o -iname \*.cpp -o -iname \*.py \)`; do
    sed -i 's/\#include \"DomainFluxIFFAB.H\"/\#include <CD_DomainFluxIFFAB.H>/g' $i
    sed -i 's/\#include <DomainFluxIFFAB.H>/\#include <CD_DomainFluxIFFAB.H>/g' $i
    sed -i 's/\#include \"DomainFluxIFFABFactory.H\"/\#include <CD_DomainFluxIFFABFactory.H>/g' $i
    sed -i 's/\#include <DomainFluxIFFABFactory.H>/\#include <CD_DomainFluxIFFABFactory.H>/g' $i
done
...
# Move files
mv Source/Utilities/DomainFluxIFFAB.H           Source/Utilities/CD_DomainFluxIFFAB.H
mv Source/Utilities/DomainFluxIFFAB.cpp         Source/Utilities/CD_DomainFluxIFFAB.cpp
mv Source/Utilities/DomainFluxIFFABFactory.H    Source/Utilities/CD_DomainFluxIFFABFactory.H
mv Source/Utilities/DomainFluxIFFABFactory.cpp  Source/Utilities/CD_DomainFluxIFFABFactory.cpp
