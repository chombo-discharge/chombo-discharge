...
int makeGeometry(Box& a_domain)
{
  ...
  if (whichgeom == 0)
  ...
  else if (whichgeom == 1)
    {
      ...
      GeometryShop workshop(ramp,RealVect::Zero, dx, a_domain);
  ...
  else if (whichgeom == 5)
    {
      ...
      GeometryShop workshop(implicit,RealVect::Zero, dx, a_domain);
      //this generates the new EBIS
      ebisPtr->define(a_domain, origin, dx, workshop);
    }
  ...
  else if (whichgeom == 18)
    {
      ...
      GeometryShop workshop(outside,RealVect::Zero, dx, a_domain);
