...
#include "CylindricalTransitionSectorMappingF_F.H"

#include "NamespaceHeader.H"

// ---------------------------------------------------------
CylindricalTransitionSectorMap::CylindricalTransitionSectorMap(/// physical coordinates of center of cylinder
...
// ---------------------------------------------------------
void CylindricalTransitionSectorMap::setPhysicalFromMap(/// physical coordinates, SpaceDim components
                                                    FArrayBox&         a_physFab,
                                                    ...
                                                    const FArrayBox&   a_mapFab) const
{
  ...
  FORT_MAPCYLINDRICALTRANSITIONSECTOR(CHF_FRA(a_physFab),
...
// ---------------------------------------------------------
void CylindricalTransitionSectorMap::setMapFromPhysical(/// mapped coordinates, SpaceDim components
                                                        FArrayBox&         a_mapFab,
                                                        /// box on which to set physical coordinates
                                                        const Box&         a_bx,
                                                        ...
                                                        const FArrayBox&   a_physFab) const
{
  RealVect cartesianOriginRefined = m_refinement * m_cartesianOrigin;
  RealVect cartesianLengthRefined = m_refinement * m_cartesianLength;
  FORT_MAPINVCYLINDRICALTRANSITIONSECTOR(CHF_FRA(a_mapFab),
...
// ---------------------------------------------------------
void CylindricalTransitionSectorMap::setJacobian(/// jacobian on a_bx
                                                 ...
                                                 const FArrayBox&   a_mapFab) const
{
  RealVect cartesianOriginRefined = m_refinement * m_cartesianOrigin;
  RealVect cartesianLengthRefined = m_refinement * m_cartesianLength;
  FORT_JACOBIANCYLINDRICALTRANSITIONSECTOR(CHF_FRA1(a_jacobianFab, 0),
                                           CHF_CONST_FRA(a_mapFab),
                                           CHF_CONST_INT(m_block),
                                           CHF_CONST_REALVECT(cartesianOriginRefined),
                                           CHF_CONST_REALVECT(cartesianLengthRefined),
