...
PlotGridEdges =  [1 1 1 1 0 0];  % Plot edges of patches of each grid at
                                 % this level on slices?
PlotCubeEdges = [1 0 0 0 0 0];   % Plot edges of cube of refinement patch at
                                 % this level?
...
% IsosurfValues    =  [0.15];     % Plot surfaces at q = surfValue(i).
