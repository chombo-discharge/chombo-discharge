...
%   to read.  Valid flags are
%
%            'ascii'        - read standard ascii Clawpack output files
%            'hdf'          - read HDF4 files produced by Clawpack
%            'chombo'       - read the HDF5 files produced by ChomboClaw.
%
...
%           end;
%
%   See also PLOTFRAME1EZ, CHOMBOCLAW.
%
