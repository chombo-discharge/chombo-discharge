% MAPC2M is a user-defined function for plotting manifolds.
%
%    If Manifold = 1 in the SETPLxOT2 matlab scripts, the Clawpack graphics
...
%
%     See  also SETPLOT, MAPPEDGRID, MANIFOLD.
