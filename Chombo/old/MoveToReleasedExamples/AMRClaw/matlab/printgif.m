...
%
%     After creating many such gif files, e.g. frame00001.gif, frame00002.gif,
%     etc, these can be merged together to make an animation using the unix
%     command gifmerge frame*.gif > movie.gif
%
