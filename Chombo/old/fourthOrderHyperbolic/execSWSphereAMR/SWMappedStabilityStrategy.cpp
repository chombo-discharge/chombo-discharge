...
//-----------------------------------------------------------------------
SWMappedStabilityStrategy::
SWMappedStabilityStrategy(Real a_stabilityFactor,
...
{
  if (!m_velocity.isNull())
    return new SWMappedStabilityStrategy(m_stabilityFactor, m_velocity);
  else
    return new SWMappedStabilityStrategy(m_stabilityFactor, m_streamFunc);
}
//-----------------------------------------------------------------------
