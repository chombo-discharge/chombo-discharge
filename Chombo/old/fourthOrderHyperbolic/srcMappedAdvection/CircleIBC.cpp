...
void CircleIBC::setParams(Real a_r0, RealVect a_center, RealVect a_x0)
{
...
void
CircleIBC::setUniformVel(const RealVect& a_vel)
{
  m_velType = uniform;
  m_uniformVel = a_vel;
}
...
void
CircleIBC::setSolidBodyRotation(const RealVect& a_rotationCenter,
                                const Real a_omega)
{
  m_velType = solidBody;
...
BasicIBC* CircleIBC::new_basicIBC()
{
  CircleIBC* retval = new CircleIBC();
...
void CircleIBC::initialize(LevelData<FArrayBox>& a_phi,
...
void
CircleIBC::advVel(LevelData<FArrayBox>& a_advVel,
                  const ProblemDomain& a_domain,
                  const CoordSys<FArrayBox,FluxBox>& a_coordSys,
...
void
CircleIBC::ghostCellBC(LevelData<FArrayBox>& a_phi,
                       const ProblemDomain& a_domain,
                       const CoordSys<FArrayBox,FluxBox>& a_coordSys,
                       Real a_dx,
                       Real a_time)
...
/// Set up initial conditions
void
CircleIBC::pointVal(FArrayBox& a_phi,
                    const ProblemDomain& a_domain,
                    const CoordSys<FArrayBox,FluxBox>& a_coordSys,
                    const Box& a_box,
                    bool a_includeJ,
