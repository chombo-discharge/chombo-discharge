...
{
  CH_assert(a_stabilityStrategy != NULL);
  CH_assert(a_taggingStategy != NULL);
  setDefaultValues();
}
...
void AMRLevelMappedConsFactory::highOrderLimiter(bool a_highOrderLimiter)
{
...
void AMRLevelMappedConsFactory::refinementIsScaled(bool a_refinementIsScaled)
{
...
void AMRLevelMappedConsFactory::tagPressure(bool a_tagPressure)
{
...
void AMRLevelMappedConsFactory::tagVorticity(bool a_tagVorticity)
{
...
void AMRLevelMappedConsFactory::molPhysics(const MOLPhysics* const a_molPhysics)
{
