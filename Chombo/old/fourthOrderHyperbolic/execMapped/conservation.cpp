...
void amrGodunov()
{
  ...
  AMRLevelMappedConsFactory amrGodFact;
  ...
  // amrGodFact.IBC(ibc);
  amrGodFact.godunovPhysics(godunovPhysics);
  amrGodFact.dtFromCells(dtFromCells);
  amrGodFact.coordinateSystemFactory(coordSysFact);
  // godunovPhysics,
  // normalPredOrder,
  // useCharLimiting,
  // useFlattening,
