...
void DefFlowIBC::initialize(LevelData<FArrayBox>& a_U)
{
  initializeUnified(a_U, false);
}

void DefFlowIBC::initializeWithJ(LevelData<FArrayBox>& a_U)
{
  initializeUnified(a_U, true);
}

// Set boundary fluxes
void DefFlowIBC::primBC(
                        FArrayBox&            a_WGdnv,
...
void DefFlowIBC::setBdrySlopes(
                               FArrayBox&       a_dW,
                               const FArrayBox& a_W,
                               const int&       a_dir,
                               const Real&      a_time)
{
  MayDay::Error("DefFlowIBC::setBdrySlopes not defined");
  // Cartesian version calls FORT_SLOPEBCSF.
}

// Adjust boundary fluxes to account for artificial viscosity
// Do nothing for this problem
void DefFlowIBC::artViscBC(
                           FArrayBox&       a_F,
                           const FArrayBox& a_U,
...
void DefFlowIBC::advVel(LevelData<FArrayBox>& a_advVel,
                        Real a_time)
{
