...
void air7_stephens::instantiate_species(){
  ...
  m_species[m_elec_idx]      = RefCountedPtr<species>      (new air7_stephens::electron());
  m_species[m_N2plus_idx]    = RefCountedPtr<species>      (new air7_stephens::N2plus());
  m_species[m_O2plus_idx]    = RefCountedPtr<species>      (new air7_stephens::O2plus());
  m_species[m_N4plus_idx]    = RefCountedPtr<species>      (new air7_stephens::N4plus());
  m_species[m_O4plus_idx]    = RefCountedPtr<species>      (new air7_stephens::O4plus());
  m_species[m_O2plusN2_idx]  = RefCountedPtr<species>      (new air7_stephens::O2plusN2());
  m_species[m_O2minus_idx]   = RefCountedPtr<species>      (new air7_stephens::O2minus());

  m_photons.resize(m_num_photons);
  m_photons[m_c4v0_X1v0_idx] = RefCountedPtr<photon_group> (new air7_stephens::phot_c4v0_X1v0());
  m_photons[m_c4v0_X1v1_idx] = RefCountedPtr<photon_group> (new air7_stephens::phot_c4v0_X1v1());
  m_photons[m_c4v1_X1v0_idx] = RefCountedPtr<photon_group> (new air7_stephens::phot_c4v1_X1v0());
  m_photons[m_c4v1_X1v1_idx] = RefCountedPtr<photon_group> (new air7_stephens::phot_c4v1_X1v1());
  m_photons[m_c4v1_X1v2_idx] = RefCountedPtr<photon_group> (new air7_stephens::phot_c4v1_X1v2());
  m_photons[m_c4v1_X1v3_idx] = RefCountedPtr<photon_group> (new air7_stephens::phot_c4v1_X1v3());
  m_photons[m_b1v1_X1v0_idx] = RefCountedPtr<photon_group> (new air7_stephens::phot_b1v1_X1v0());
  m_photons[m_b1v1_X1v1_idx] = RefCountedPtr<photon_group> (new air7_stephens::phot_b1v1_X1v1());
