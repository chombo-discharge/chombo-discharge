...
neumann_func::neumann_func(const Real a_curveReal (*a_func)(const RealVect a_pos),
...
Real neumann_func::derivative(const RealVect& a_point, const int& a_comp, const int& a_dir) const {
  MayDay::Abort("poisson_multifluid_gmg::neumann_func::derivative - this should not be called. How did you get here?");
}
