...
void vertex::define(const RealVect& a_pos, const std::shared_ptr<dcel_edge>& a_edge, const RealVect a_normal){
  this->set_pos(a_pos);
...
void vertex::set_edge(const std::shared_ptr<dcel_edge>& a_edge){
  m_edge = a_edge;
}
...
void vertex::add_polygon(const std::shared_ptr<dcel_poly>& a_poly){
  m_polycache.push_back(a_poly);
}

std::vector<std::shared_ptr<dcel_poly> > vertex::get_polygons() {
...
const std::vector<std::shared_ptr<dcel_poly> >& vertex::get_polycache() const{
  return m_polycache;
}

std::vector<std::shared_ptr<dcel_poly> >& vertex::get_polycache(){
  return m_polycache;
}

const std::shared_ptr<dcel_edge>& vertex::get_edge() const{
  return m_edge;
}

std::shared_ptr<dcel_edge>& vertex::get_edge(){
  return m_edge;
}
