...
def write_template(args):
    ...
    options_files = [args.plasmac_home + "/src/amr_mesh/amr_mesh.options", \
                     ...
                     args.plasmac_home + "/src/rte_solver/mc_photo.options",\
                     args.plasmac_home + "/src/geometry/geo_coarsener.options", \
                     args.plasmac_home + "/geometries/" + args.geometry + "/" + args.geometry + ".options", \
                     args.plasmac_home + "/physics/ito_plasma/time_steppers/" + args.time_stepper + "/" + args.time_stepper + ".options", \
                     args.plasmac_home + "/physics/ito_plasma/plasma_models/" + args.physics + "/" + args.physics + ".options"]

    if not args.cell_tagger == "none":
        options_files.append(args.plasmac_home + "/physics/ito_plasma/cell_taggers/" + args.cell_tagger + "/" + args.cell_tagger + ".options")
