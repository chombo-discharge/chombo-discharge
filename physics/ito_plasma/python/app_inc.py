...
def copy_dependencies(args):
    ...
    kin_home = args.plasmac_home + "/physics/ito_plasma/plasma_models" + "/" + args.physics
    kin_name = args.plasmac_home + "/physics/ito_plasma/plasma_models" + "/" + args.physics + "/" + args.physics
