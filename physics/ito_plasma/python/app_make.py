...
def write_template(args):
    ...
    makef.write('\t$(PLASMAC_HOME)/src/ito_solver \\\n')
    ...
    makef.write('\t$(PLASMAC_HOME)/physics/ito_plasma \\\n')
    if not args.cell_tagger == "none":
        makef.write('\t$(PLASMAC_HOME)/physics/ito_plasma/cell_taggers/'  + args.cell_tagger + '\\\n')
    makef.write('\t$(PLASMAC_HOME)/physics/ito_plasma/time_steppers/' + args.time_stepper + '\\\n')
    makef.write('\t$(PLASMAC_HOME)/physics/ito_plasma/plasma_models/' + args.physics + '\n')
    makef.write('\n')
