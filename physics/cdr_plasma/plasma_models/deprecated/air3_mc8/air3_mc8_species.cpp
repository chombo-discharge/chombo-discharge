...
Real air3_mc8::electron::initialData(const RealVect a_pos, const Real a_time) const{
...
Real air3_mc8::M_plus::initialData(const RealVect a_pos, const Real a_time) const{
  const Real factor = (a_pos - m_seed_pos).vectorLength();
