...
parser.add_argument('-plasmac_home',    type=str,  help="Source code base directory", default=os.environ.get('DISCHARGE_HOME', os.getcwd()))
...
parser.add_argument('-rte_solver',      type=str,  help="Poisson solver implementation", default="poisson_multifluid_gmg")
...
if not args.plasmac_home:
    ...
    print "DISCHARGE_HOME is " + args.plasmac_home
